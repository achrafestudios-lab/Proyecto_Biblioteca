...
public class LibroException extends Exception {
    ...
    public static final String ERROR_NO_EXISTE_EL_LIBRO_AUTOR = "No existe ningún libro con ese autor en la base de datos. ";
    public static final String ERROR_EXISTE_EL_LIBRO = "Ya existe el libro con ese ISBN en la base de datos.";
